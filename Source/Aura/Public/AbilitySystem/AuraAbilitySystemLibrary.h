...
public:
	...
	static void GetLivePlayersWithinRadius (const UObject* WorldContextObject, TArray<AActor*>& OutCharacters, const TArray<AActor*>& ActorsToIgnore, float Radius, const FVector& SphereOrigin);
};
